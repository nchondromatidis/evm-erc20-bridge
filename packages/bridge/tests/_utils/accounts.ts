  ...
  return {
    ...
    chainA: {
      solver: {
        ...
        privateKey: hardhatNodeAccounts[0].privateKey,
      },
      userA: {
        address: hardhatNodeAccounts[1].address,
        privateKey: hardhatNodeAccounts[1].privateKey,
      },
      userB: {
        address: hardhatNodeAccounts[2].address,
        privateKey: hardhatNodeAccounts[2].privateKey,
      },
    },
    chainB: {
      solver: {
        address: hardhatNodeAccounts[10].address,
        privateKey: hardhatNodeAccounts[10].privateKey,
      },
      userA: {
        address: hardhatNodeAccounts[11].address,
        privateKey: hardhatNodeAccounts[11].privateKey,
      },
      userB: {
        address: hardhatNodeAccounts[12].address,
        privateKey: hardhatNodeAccounts[12].privateKey,
      },
    },
  };
}
